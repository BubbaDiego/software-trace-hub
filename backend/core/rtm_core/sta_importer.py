...
def _import_sw_trace(
    ws, project_id: int, srd_lookup: dict[str, list[int]], db: RTMDatabase
) -> dict:
    ...
    header_rows = 2  # Row 1 = group header, Row 2 = column headers
    row_num = 0
    ...
    for row in ws.iter_rows(max_col=16, values_only=True):
        ...
        for req_id in req_ids:
            ...
            # Per-module evidence + total evidence
        ...
        # Batch commit every 200 SRD rows
